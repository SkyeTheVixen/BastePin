<?php
    ...
    if(isset($_GET["BasteID"]) && $_GET["BasteID"] != "") {
        ...
        //FavouriteCount
        $sql = "SELECT * FROM `tblFavourites` WHERE `BasteID` = ?";
        $stmt = $mysqli -> prepare($sql);
        ...
        <div class="row">
            <div class="col-12 align-items-right text-right">
                <div class="row">
                    ...
                    <div class="col-1">
                        <a id="fav" href="#" data-basteid="<?php echo $basteID;?>" class="no-underline">
                            <h4><i id="favouriteIcon"
                                    <?php if($favres->num_rows > 0){echo "class='fas fa-star'";} else {echo "class='far fa-star'";} ?>></i> <span class="text-muted" id="favCount"><?= $favcountres->num_rows; ?></span>
                            </h4>
                        </a>
                    </div>
                    <div class="col-1">
